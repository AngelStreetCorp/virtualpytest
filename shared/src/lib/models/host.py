...
class Host:
    ...
    def __init__(self, host_ip: str, host_port: int, host_name: str, host_url: str = None, host_os: str = None):
        """
        Initialize a host.
        ...
        Args:
            ...
            host_os: Host operating system ('linux', 'darwin', 'windows', etc.)
        """
