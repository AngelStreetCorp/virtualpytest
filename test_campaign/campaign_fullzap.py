...
This script creates and executes a test campaign that runs tv/fullzap.py with configurable
...
Examples:
    ...
    python test_campaign/campaign_fullzap.py example_mobile
    python test_campaign/campaign_fullzap.py example_mobile --max-execution 5 --timeout-minutes 120
    python test_campaign/campaign_fullzap.py example_mobile --max-iteration 3 --max-execution 10 --timeout-minutes 180
"""
...
def create_campaign_config(userinterface_name: str, host: str = "auto", device: str = "auto", max_iteration: int = 2, max_execution: int = 1, timeout_minutes: int = 60) -> dict:
    ...
    config = {
        ...
        "description": f"Execute tv/fullzap.py with goto_live=True once, then {max_execution} times with goto_live=False (max_iteration={max_iteration})",
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Execute configurable fullzap campaign - runs tv/fullzap.py with customizable parameters"
    )
    
    parser.add_argument(
        'userinterface_name',
        nargs='?',
        default='example_mobile',
        help='User interface name (default: example_mobile)'
    )
