...
│   │  └── Heatmap Processor       │  │  ← Background tasks
│   └──────────────────────────────┘  │
│                                      │
...
- **`Dockerfile`** - Recipe that says "install Python, copy code"
- **`docker-compose.yml`** - Says "run the container, open port 5109"
