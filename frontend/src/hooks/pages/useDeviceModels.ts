...
class DeviceModelServerService {
  ...
  async getAllDeviceModels(): Promise<Model[]> {
    try {
      ...
      const data = await api.get(buildServerUrl('/server/devicemodel/getAllModels'));
      console.log(
  ...
  async getDeviceModel(id: string): Promise<Model> {
    try {
      ...
      const data = await api.get(buildServerUrl(`/server/devicemodel/getDeviceModel/${id}`));
      console.log(
  ...
  async createDeviceModel(model: Omit<Model, 'id' | 'created_at' | 'updated_at'>): Promise<Model> {
    try {
      ...
      const result = await api.post(buildServerUrl('/server/devicemodel/createDeviceModel'), model);
  ...
  async updateDeviceModel(
    ...
    try {
      ...
      const result = await api.put(buildServerUrl(`/server/devicemodel/updateDeviceModel/${id}`), model);
  ...
  async deleteDeviceModel(id: string): Promise<void> {
    try {
      ...
      await api.delete(buildServerUrl(`/server/devicemodel/deleteDeviceModel/${id}`));
