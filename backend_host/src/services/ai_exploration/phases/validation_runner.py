        ...
        try:
            ...
            try:
                ...
                if before_ok_screenshot:
                    ...
                    host = get_host()
                    before_ok_url = buildHostImageUrl({'host_name': host.host_name, 'host_url': host.host_url, 'host_api_url': getattr(host, 'host_api_url', None)}, before_ok_screenshot)
            ...
            try:
                ...
                if after_ok_screenshot:
                    ...
                    host = get_host()
                    after_ok_url = buildHostImageUrl({'host_name': host.host_name, 'host_url': host.host_url, 'host_api_url': getattr(host, 'host_api_url', None)}, after_ok_screenshot)
